          ...
          <div class="profile-desc">
            <div class="profile-pic">
              ...
              <div class="profile-name">
                <h5 class="mb-0 font-weight-normal">★KING MAKER™</h5>
                <span>My Fav Members</span>
              </div>
            </div>
        </li>
      </ul>
        ...
        <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
              <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/kingmaker2662">Welcome By ★KING MAKER™ </a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                <div class="navbar-profile">
                  <img class="img-xs rounded-circle" src="face15.jpg" alt="">
                  <p class="mb-0 d-none d-sm-block navbar-profile-name">★KING MAKER™</p>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">Stripe Based</h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page">Stripe Based Donation</li>
              </ol>
            </nav>
          </div>
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3><span style="color:#ffa100"><b>Drop CC's Here</b></span>
                  </h3>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <center>
                  <button class="btn btn-outline-info" id="testar" onclick="enviar()">JERK ON</button>
              </div>
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Check the Responses here</h4>
                ...
                <footer class="footer">
                  <div class="footer__block block no-margin-bottom">
                    <div class="container-fluid text-center">
                      ...
                      <p class="no-margin-bottom">2021 &copy; Your company. Design by <a href="https://telegram.dog/kingmaker2662">★KING MAKER™</a>.</p>
                    </div>
                  </div>
                </footer>
                <!-- partial -->
